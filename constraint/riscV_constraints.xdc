...
set_property PACKAGE_PIN U9 [get_ports new_instruction_write_enable]					
	set_property IOSTANDARD LVCMOS33 [get_ports new_instruction_write_enable]
...
#set_property PACKAGE_PIN T8 [get_ports {exception_led}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {exception_led}]
#set_property PACKAGE_PIN T8 [get_ports {io_data_packet[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {io_data_packet[0]}]
##Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
#set_property PACKAGE_PIN V9 [get_ports {io_data_packet[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {io_data_packet[1]}]
##Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
#set_property PACKAGE_PIN R8 [get_ports {io_data_packet[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {io_data_packet[2]}]
##Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = LED3
#set_property PACKAGE_PIN T6 [get_ports {io_data_packet[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {io_data_packet[3]}]
##Bank = 34, Pin name = IO_L12P_T1_MRCC_34,					Sch name = LED4
#set_property PACKAGE_PIN T5 [get_ports {io_data_packet[4]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {io_data_packet[4]}]
##Bank = 34, Pin name = IO_L12N_T1_MRCC_34,					Sch	name = LED5
#set_property PACKAGE_PIN T4 [get_ports {io_data_packet[5]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {io_data_packet[5]}]
##Bank = 34, Pin name = IO_L22P_T3_34,						Sch name = LED6
#set_property PACKAGE_PIN U7 [get_ports {io_data_packet[6]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {io_data_packet[6]}]
##Bank = 34, Pin name = IO_L22N_T3_34,						Sch name = LED7
#set_property PACKAGE_PIN U6 [get_ports {io_data_packet[7]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {io_data_packet[7]}]
...
#set_property PACKAGE_PIN P2 [get_ports io_data_valid]					
#	set_property IOSTANDARD LVCMOS33 [get_ports io_data_valid]
...
set_property PACKAGE_PIN E16 [get_ports clear_ram]
	set_property IOSTANDARD LVCMOS33 [get_ports clear_ram]
